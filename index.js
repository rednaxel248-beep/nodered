...
const UUID = process.env.UUID || 'e6054ac5-3c86-4544-a1c3-cb36cc5b5b03'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || '';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'red1.0xxblackxx0.eu.cc';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiODMyYWI3NWRkZTMyOTk2MjJhZGQ5NDAxZDQ4MmFjZjEiLCJ0IjoiODVjMDA1N2YtZDhkYi00NThhLTlkMTQtMGY1NjIxOGQ3NTRmIiwicyI6Ik5EVm1abVZpWkRndFpqUTFZaTAwTldZNExXSmxNV010WlRZNE1HVmxOekpqTlRVMyJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
...
const NAME = process.env.NAME || 'red';                        // 节点名称
